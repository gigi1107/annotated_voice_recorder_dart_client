...
class UserPhraseApi {
  ...
  Future deleteUserPhrase(UserPhrase userPhrase) async {
    ...
    // verify required params are set
    if(userPhrase == null) {
     throw new ApiException(400, "Missing required param: userPhrase");
    }

    // create path and map variables
    String path = "/userPhrase/{userPhrase}".replaceAll("{format}","json").replaceAll("{" + "userPhrase" + "}", userPhrase.toString());
