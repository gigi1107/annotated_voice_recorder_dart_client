...
/// tests for UserPhraseCommentApi
void main() {
  var instance = new UserPhraseCommentApi();

  group('tests for UserPhraseCommentApi', () {
    // Add a new UserPhraseComment to the Database
    //
    //Future<UserPhraseComment> addUserPhraseComment(UserPhraseComment body) async
    test('test addUserPhraseComment', () async {
      // TODO
    });
    ...
    test('test deleteUserPhraseComment', () async {
      // TODO
    });
    ...
    test('test getUserPhraseComment', () async {
      // TODO
    });
